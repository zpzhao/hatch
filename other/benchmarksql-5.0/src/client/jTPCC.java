...
public class jTPCC implements jTPCCConfig {
	...
	public static void main(String args[]) {
		...
		PropertyConfigurator.configure(System.getProperty("log"));
		new jTPCC();
	}
	...
	public jTPCC() {
		...
		String osCollectorScript = null ; // getProp(ini, "osCollectorScript");
				...
				try {
					...
					for (int i = 0; i < numTerminals; i++) {
						...
						jTPCCTerminal terminal = new jTPCCTerminal(terminalName, terminalWarehouseID,
								...
								paymentWeightValue, orderStatusWeightValue, deliveryWeightValue, stockLevelWeightValue,
